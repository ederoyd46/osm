...
type Info struct {
	...
	UserSid          *int32 `protobuf:"varint,5,opt,name=user_sid" json:"user_sid,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type ChangeSet struct {
	...
	CreatedAt        *int64      `protobuf:"varint,8,req,name=created_at" json:"created_at,omitempty"`
	ClosetimeDelta   *int64      `protobuf:"varint,9,opt,name=closetime_delta" json:"closetime_delta,omitempty"`
	Open             *bool       `protobuf:"varint,10,req,name=open" json:"open,omitempty"`
...
func (m *ChangeSet) GetClosetimeDelta() int64 {
	if m != nil && m.ClosetimeDelta != nil {
		return *m.ClosetimeDelta
	}
	return 0
}
...
func (m *ChangeSet) GetBbox() *HeaderBBox {
	if m != nil {
		return m.Bbox
	}
	return nil
...
type Relation struct {
	...
	Types            []Relation_MemberType `protobuf:"varint,10,rep,packed,name=types,enum=Relation_MemberType" json:"types,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}
...
func init() {
	proto.RegisterEnum("Relation_MemberType", Relation_MemberType_name, Relation_MemberType_value)
}
